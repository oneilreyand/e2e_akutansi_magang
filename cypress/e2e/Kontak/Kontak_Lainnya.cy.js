describe("Menguji Bagian Lainnya pada website Cashflow Assist id dihalaman Kontak", () => {
    ...
    it("Case 3 : menekan navigasi Lainnya dan akan mengarah ke bagian Lainnya pada halaman yang sama", () => {
        cy.visit("https://cashflow.assist.id/admin/contacts")
        cy.get('#simple-tab-3').should("be.visible").contains("Lainnya").click()
        cy.log("jika berhasil maka akan muncul judul Lainnya")
    ...
    it("Case 4 : Memeriksa ketersediaan tabel dan kolom yang ada pada Lainnya di kontak", () => {
        //* tabel
        cy.visit("https://cashflow.assist.id/admin/contacts")
    ...
    it("Case 5 : memeriksa apakah data yang ada pada table Lainnya itu tersedia", () => {
        cy.visit("https://cashflow.assist.id/admin/contacts")
