...
describe('Testing fitur pada login page', () => {
    ...
    it.only('001 - Tombol kembali pada logo ditekan >> kembali ke halaman awal - Tidak berubah', () => {
        
        cy.get('[href="/"]')
            .should('exist')
            .click()
            .then(() => {
                cy.log('Tombol ditekan')
            })
        cy.url()
            .should('eq', 'https://cashflow.assist.id/')
            .then(() => {
                cy.log('Berhasil kembali dan tidak berubah')
            })
    })

    it('002 - Alamat email & password kosong >> Warning email & password required muncul - Tidak dapat login', () => {
        cy.get('#email')
            .should('exist')
            .and('be.visible')
    ...
    it('003 - Alamat email terisi dengan alamat yang valid namun tidak terdaftar dan untuk password kosong >> Warning email tidak terlihat & password required muncul - Tidak dapat login', () => {
    ...
    it('004 - Alamat email terisi namun alamat tidak valid dan password kosong >> Warning email terlihat & password required muncul - Tidak dapat login', () => {
    ...
    it('005 - Alamat email valid dan terdaftar namun password salah >> Warning email terlihat & password required muncul - Tidak dapat login', () => {
    ...
    it('007 - Alamat email kosong namun password terisi dengan password asal asalan >> Muncul email helper email required - Tidak dapat login', () => {
    ...
    it('008 - Alamat email kosong namun password terisi dengan salah satu password yang terdaftar >> muncul email helper email required - Tidak dapat login', () => {
    ...
    it('009 - Menghapus input text setelah diisi >> placeholder terlihat ', () => {
    ...
    it('010 - Logika helper tidak muncul saat pertama kali input >> helper hanya muncul saat elemen lain dipilih (Email & Password) - helper berubah setelah ada kesalahan atau input kosong', () => {
        cy.get('#email')
    ...
    it('011 - Fitur sembunyikan password > eksistensi hitbox dan visibilitas icon bila ditekan maka akan berubah - svg-path berubah dan kolom password berubah type menjadi text(terlihat) dan type password(tak terlihat)', () => {
    ...
    it('012 - Fitur Remember me > visibilitas icon dan eksistensi hitbox serta perubahan icon bila ditekan - svg checked dan uncheck', () => {
    ...
    it('013 - Tombol Lupa Password bila ditekan > Pindah ke halaman lupa password - Mengambil salah satu element h5 validasi perpindahan halaman', () => {
    ...
    it('014 - Tombol Daftar sekarang bila ditekan > Pindah ke halaman daftar - Mengambil salah satu element h5 validasi perpindahan halaman', () => {
